...
def sort_dict_by_keys(dictionary, keys):
    ...
    try:
        ...
        raise Exception(f"Failed to sort dict by keys. Error: {str(e)}")

    return new_dict


if __name__ == "__main__":
    xs = ['वेबसाइट डिज़ाइनर', 'ई कॉमर्स एजेंसी', 'ग्राफ़िक डिज़ाइनर',
          'इंटरनेट विपणन सेवा', 'विपणन एजेंसी', 'सॉफ़्टवेयर कंपनी', 'वेब होस्टिंग कंपनी']
    print(', '.join(xs[0]))
